...
def subtitle_translate(srt_file, from_lang='auto', to_lang='auto'):
...
if __name__ == '__main__':
    ...
    subtitle_file = "output/重庆森林片段.srt"
    trans_srt_data = subtitle_translate(subtitle_file, from_lang='zh', to_lang='en')
    save_srt_file(trans_srt_data, "output/重庆森林片段_en.srt")    